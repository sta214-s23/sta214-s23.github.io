...
**Due dates:** There are three separate submissions for this project: two check-ins and a final report. The check-ins will help guide you and give you feedback as you work on the project. You will incorporate this feedback into your final report, where you put everything together. *Note:* you will not know how to do everything when this project is first assigned. That's ok! I am assigning the project early so you can work on it as you learn the material.

* **Check-in 1**: due Friday, February 3 at 12pm (noon) on Canvas
* **Check-in 2**: due Friday, February 17 at 12pm (noon) on Canvas
* **Final report**: due Friday, March 3 at 12pm (noon) on Canvas
...
For the first check-in, you will perform exploratory data analysis and write up your results. You will submit two documents on Canvas for check-in 1:
...
Your written report for check-in 1 will contain three sections: Data Summary, Univariate EDA, and Multivariate EDA.
...
For the second check-in, you will fit a model, perform model diagnostics, and use the model to address the research questions. You will submit two documents on Canvas for check-in 2:
...
Your written report for check-in 1 will contain two sections, one for each research question: Exercise and weight loss goals, and Predicting exercise.
