...
**Due:** Monday, April 24, 12:00pm (noon) on Canvas

**Submission:** Submit *both* an HTML containing your report, and a file containing the R code you used in your analysis.
...
```r
serengeti <- read.csv("https://sta214-s23.github.io/projects/serengeti.csv")
```

# Research question

You are asked by the research team to build models for the count of each species observed at the different sites. In particular, they are interested in the following question:

1. Is there a relationship between the environmental variables and the counts for each species?

To address this research question, you will perform exploratory data analysis, fit several models, and analyze the results.
...
In this section, you will build one or more models to answer the research question. For each model, make sure to include the population form of the model you are using and explain why this model is appropriate for these data.
...
Compare your results from Section 3.1 between the models for each species. Are the results the same for each species? Comment on any relationships you see in the models.
