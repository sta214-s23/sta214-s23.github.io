...
.large[
[https://sta214-s23.github.io/class_activities/ca_lecture_29.html](https://sta214-s23.github.io/class_activities/ca_lecture_29.html)
]
...
```{r, echo=F, message=F, fig.align='center', fig.width=10, fig.height=5}
...
.large[
.question[
How does the plot change if I increase $\sigma_u^2$?
]
]
...
.large[
.question[
How does the plot change if I increase $\sigma_\varepsilon^2$?
]
]
...
.large[
.question[
How does the plot change if I increase $\beta_1$?
]
]
