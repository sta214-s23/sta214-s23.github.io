...
.large[
[https://sta214-s23.github.io/class_activities/ca_lecture_10.html](https://sta214-s23.github.io/class_activities/ca_lecture_10.html)
]
...
p1 <- logodds_plot(titanic, 30, "equal_size", "Fare", "Survived", reg_formula = y ~ log(x)) + 
  labs(title = "Log transformation") + 
  theme(text = element_text(size = 20))

p2 <- titanic %>% 
  mutate(logFare = log(Fare + 1)) %>%
  logodds_plot(30, "equal_size", "logFare", "Survived", reg_formula = y ~ x) + 
  labs(title = "Log transformation") +
  theme(text = element_text(size = 20))
